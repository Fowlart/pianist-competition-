...
const CommonWrapper = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div`
  background: url("${_1163023_png__WEBPACK_IMPORTED_MODULE_7___default.a}") no-repeat center fixed;
